      ...
      <div class="card mb-3" style="max-width: fit-content;">
        <div class="row no-gutters">
          <div class="col-md-4">
            ...
            <img src="https://image.shutterstock.com/image-photo/auction-bid-sale-judgment-mallet-600w-660011272.jpg" class="card-img" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
            <h5 class="card-title">${auction.event_id}.${auction.eventName}</h5>
              <p class="card-text">${auction.descc}</p>
